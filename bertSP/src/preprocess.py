...
if __name__ == '__main__':
    ...
    parser.add_argument('-types', default='gold', choices=['gold', 'linked', 'none'])
    parser.add_argument('-nentities', default='gold', choices=['gold', 'lgnel', 'allennel', 'strnel'])
    parser.add_argument('-kb_graph', default='knowledge_graph')
